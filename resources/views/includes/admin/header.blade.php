                ...
                <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                    ...
                    <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs"
                        ...
                        <ul class="nav flex-nowrap text-nowrap">
                            <li class="nav-item">
                                <a class="nav-link @if (Request::segment(1) == 'spmv2') active @endif" data-bs-toggle="tab"
                                    href="#">Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if (Request::segment(1) == 'rkakl') active @endif "
                                    data-bs-toggle="tab" href="#kt_header_navs_tab_1">RKA-KL</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="d-lg-flex container-xxl w-100">
            ...
            <div class="d-lg-flex flex-column justify-content-lg-center w-100" id="kt_header_navs_wrapper">
                ...
                <div class="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}"
                    ...
                    <!--begin::Tab panel-->
                    <div class="tab-pane @if (Request::segment(1) == 'rkakl') show active @endif"
                        ...
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            ...
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0"
                                ...
                                <a href="{{ route('rkakl.indexv2') }}"
                                    class="menu-item  @if (Request::segment(2) == 'data-rkakl') here show @endif me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                ...
                                <!--end:Menu item-->
                                <!--begin:Menu item-->
                                <a href="{{ route('kegiatan.indexv2') }}"
                                    class="menu-item  @if (Request::segment(2) == 'kegiatan') here show @endif me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <span class="menu-link py-3">
                                        Kegiatan
                                    </span>
                                ...
                                <!--end:Menu item-->
                                <!--begin:Menu item-->
                                <a href="{{ route('akun.indexv2') }}"
                                    class="menu-item  @if (Request::segment(2) == 'akun') here show @endif me-0 me-lg-2">
                                    <!--begin:Menu link-->
                                    <span class="menu-link py-3">
                                        Jenis Akun
                                    </span>
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_5">
                        ...
                        <div class="d-flex flex-column flex-lg-row flex-lg-stack flex-wrap gap-2 px-4 px-lg-0">
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                <a class="btn btn-sm btn-light-primary fw-bold"
                                    href="https://preview.keenthemes.com/html/metronic/docs/getting-started">Documentation</a>
                                <a class="btn btn-sm btn-light-success fw-bold"
